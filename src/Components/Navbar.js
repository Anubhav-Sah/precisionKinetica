...
function Navbar() {
  ...
  return (
    ...
    >
      ...
      {/* Desktop Menu */}
      <div className="hidden md:flex gap-6 text-sm font-medium items-center relative flex-1 justify-center">
        {navLinks.map((link) => (
          <NavLink
            key={link.path}
            to={link.path}
            className={({ isActive }) =>
              `flex items-center gap-2 transition ${isActive ? "text-black font-medium" : "text-gray-700 hover:text-black"
              }`
            }
          >
            {({ isActive }) => (
          ...
          {insightsOpen && (
            ...
            >
              <NavLink
                to="/news"
                className={({ isActive }) =>
                  `flex items-center gap-2 px-4 py-2 transition ${isActive ? "text-black font-medium" : "text-gray-700 hover:bg-gray-100"
                  }`
                }
              >
                {({ isActive }) => (

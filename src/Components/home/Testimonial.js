  ...
  const newsItems = [
    {
      ...
      date: "July 9, 2025",
      iconPath:
        "M19 21l-7-5-7 5V5a2 2 0 012-2h10a2 2 0 012 2z", // Bookmark icon
    },
    {
      title:
        "Iambic Completes Dose Escalation in Ongoing Phase 1/1B Study",
      ...
      date: "June 4, 2025",
      iconPath:
        "M15 12H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z", // Circle minus icon
    },
    {
      title: "Iambic Named to CNBC’s 2025 Disruptor 50 List",
      date: "June 10, 2025",
      iconPath:
        "M3 10h11M9 21V3m12 7h-4m0 0l-2 3m2-3l2 3", // Arrow chart icon
    },
    {
      title:
        "Iambic Completes Dose Escalation in Ongoing Phase 1/1B Study",
      ...
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="w-full flex flex-col gap-8">
          {newsItems.map((item, index) => (
            <div
              key={index}
              className="group bg-white border border-blue-100 rounded-3xl p-6 flex flex-col md:flex-row items-center md:items-start gap-6 shadow-lg transition-transform duration-300 hover:scale-105 hover:shadow-blue-200"
            >
              {/* Icon */}
              <div className="w-16 h-16 flex items-center justify-center rounded-full bg-gradient-to-br from-blue-200 to-blue-400 shadow-lg group-hover:scale-110 transition-transform">
                <svg

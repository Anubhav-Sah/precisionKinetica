...
function TrustedBy() {
  const companies = [
    ...
    // Add more here: "HealthNext", "Another Company"
  ];
      ...
      <div className="max-w-5xl mx-auto flex flex-col items-center">
        ...
        <div className="flex flex-wrap justify-center gap-12 mb-8">
          {companies.map((company, index) => (
            <div
              key={index}
              className="w-36 h-12 relative group rounded-lg border border-blue-700 shadow-md overflow-hidden flex items-center justify-center transition-all duration-300 bg-blue-700"
            >
